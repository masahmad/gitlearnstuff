    ...
    $(document).ready(function() {
      ...
      //  $(function() { $("#divResize").draggable().resizable(); });
        ...
        $('#btClickMe').click(function() {
			...
			'style="border:1px solid; position:absolute;left:'+element_pos+';left:30px;position:absolute;width:200px;height:200px; margin:0;top:'+top1+'"'+
			  '</div>';
			  
			$(elm1).appendTo('.content_block').draggable({ containment: "parent" }).resizable({
	  maxWidth: 610,
      minHeight: 12,
	  minWidth: 15,
	  maxHeight:300
